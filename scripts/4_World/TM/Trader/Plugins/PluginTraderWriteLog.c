static void TM_Print(string message)
{
    PluginTraderWriteLog m_Logger = PluginTraderWriteLog.Cast(GetPlugin(PluginTraderWriteLog));
    if(m_Logger)
    {
