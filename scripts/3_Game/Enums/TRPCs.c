...
{
	// Client -> Server
	RPC_SPAWN_ITEM_ON_GROUND = 1000,
	RPC_CREATE_ITEM_IN_INVENTORY,
	RPC_DELETE_ITEM,
	RPC_SET_ITEM_AMOUNT,
	RPC_INCREASE_PLAYER_CURRENCY,
	RPC_REQUEST_TRADER_DATA,
	RPC_TRADER_MOD_IS_LOADED,
#ifdef Trader_Debug
	RPC_DEBUG_TELEPORT, // DEBUG!
	RPC_TEST_PLACE_PREVIEW_OBJECT, // TEST!
	RPC_TEST_PLACE_OBJECT, // TEST!
	RPC_TEST_DELETE_OBJECT, // TEST!
	RPC_TEST_REPOS_OBJECT, // TEST!
	RPC_TEST_REDIR_OBJECT, // TEST!
	RPC_TEST_SAVE_OBJECTS, // TEST!
#endif
